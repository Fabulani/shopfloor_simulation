"""
    Digital Twin Viewer basic example scenario for flexibility 1.
    ...
    State Flow: State01 -> State02 -> Shutdown -> load scenario basic_flex0
"""
...
class Shutdown(State):
    def run(self):
        ...
        Scenario.manager.flexibility = 0
        sleep(STATE_SLEEP)

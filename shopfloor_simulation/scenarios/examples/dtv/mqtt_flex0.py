"""
    Digital Twin Viewer example scenario for flexibility 0 with MQTT subscribing
...
# Instantiate Station
Station1 = Station("Station-001", "Station11", "stations", "I'm Station 001!")
